    ...
    <DashboardLayout>
      <div className="space-y-6 p-4 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Votre Progression</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Suivez vos performances et améliorez-vous</p>
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${
                  timeRange === range
                    ...
                    : "bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-slate-700 hover:border-teal-600"
                }`}
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {/* Total Attempts */}
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
            ...
            <p className="text-3xl font-bold text-gray-800 dark:text-white">{data.totalAttempts}</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
            ...
            <p className="text-3xl font-bold text-gray-800 dark:text-white">{data.averageScore}%</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
            ...
            <p className="text-3xl font-bold text-gray-800 dark:text-white">{data.bestScore}%</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
            ...
            <p className="text-3xl font-bold text-gray-800 dark:text-white">{data.successRate}%</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {data.scoresBySubject.map((subject, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 dark:bg-slate-700 transition-all">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg font-bold text-gray-800 dark:text-white w-12 text-right">{subject.score}%</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-teal-50 to-blue-50 p-6 rounded-xl border border-teal-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-white">Temps total</h3>
            </div>
            <p className="text-3xl font-bold text-teal-600">{data.totalTimeSpent}h</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Temps d&apos;étude cumulé</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl border border-blue-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-white">Cette semaine</h3>
            </div>
            <p className="text-3xl font-bold text-blue-600">{data.thisWeekAttempts}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Tentatives cette semaine</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-white">Ce mois</h3>
            </div>
            <p className="text-3xl font-bold text-purple-600">{data.thisMonthAttempts}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Tentatives ce mois</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
