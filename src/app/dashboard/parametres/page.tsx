  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 p-4 md:p-6 bg-gray-50 dark:bg-slate-800 min-h-screen">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 dark:text-white">Paramètres</h1>
          <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">Gérez vos préférences et votre sécurité</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Prénom</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Nom</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Ville</label>
              <select
                value={settings.city}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Année académique</label>
              <input
                type="text"
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Email</label>
              <input
                type="email"
                value={settings.email}
                disabled
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-slate-800 cursor-not-allowed"
              />
        ...
        <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <label className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg hover:bg-gray-100 dark:bg-slate-700 transition-all cursor-pointer">
              <input
                type="checkbox"
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-800 dark:text-gray-100 dark:text-white">Recevoir les notifications par email</p>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Soyez informé des mises à jour importantes</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg hover:bg-gray-100 dark:bg-slate-700 transition-all cursor-pointer">
              ...
              />
              <div className="flex-1">
                <p className="font-medium text-gray-800 dark:text-gray-100 dark:text-white">Recevoir les rappels de QCM</p>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Recevez des rappels pour continuer vos études</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg hover:bg-gray-100 dark:bg-slate-700 transition-all cursor-pointer">
              ...
              />
              <div className="flex-1">
                <p className="font-medium text-gray-800 dark:text-gray-100 dark:text-white">Partager mes statistiques</p>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Permettre aux autres utilisateurs de voir vos performances</p>
              </div>
            </label>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 p-6">
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Mot de passe actuel</label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 dark:text-gray-200"
                >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Nouveau mot de passe</label>
              <div className="relative">
                <input
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">Confirmer le mot de passe</label>
              <div className="relative">
                <input
