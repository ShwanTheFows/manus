    ...
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Chargement des QCMs...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Session Header */}
        <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-lg shadow-md p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 dark:text-white">
                Session QCMs
              </h1>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200">
        ...
        {!isCurrentSubmitted ? (
          <>
            {/* Question Card */}
            <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-lg shadow-md p-8 mb-6">
              <div className="mb-8">
                <h2 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-100 dark:text-white leading-relaxed">
                  {question.text}
                </h2>
              </div>
                      ...
                      className={`
                        ...
                        ${
                          selected
                            ...
                            : "border-gray-200 dark:border-slate-700 dark:border-slate-700 bg-white dark:bg-slate-900 dark:bg-slate-800 hover:border-teal-300 hover:bg-teal-50"
                        }
                      `}
                    >
                          ...
                          className={`
                            ...
                            ${
                              selected
                                ...
                                : "border-gray-300 bg-white dark:bg-slate-900 dark:bg-slate-800"
                            }
                          `}
                        >
                          {selected && (
                            <div className="w-2 h-2 bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-full"></div>
                          )}
                        </div>
                        <span className="text-gray-800 dark:text-gray-100 dark:text-white font-medium leading-relaxed">
                          {option.text}
                        </span>
                      </div>
                    </button>
            ...
            <div className="flex gap-4 mb-6">
                ...
                className={`
                  ...
                  ${
                    currentQuestion === 0
                      ...
                      : "bg-white dark:bg-slate-900 dark:bg-slate-800 text-gray-700 dark:text-gray-200 dark:text-gray-200 border-2 border-gray-300 hover:border-gray-400"
                  }
                `}
              >
                ← Précédent
              ...
              {currentQuestion < currentQcm.questions.length - 1 ? (
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-lg font-medium bg-white dark:bg-slate-900 dark:bg-slate-800 text-gray-700 dark:text-gray-200 dark:text-gray-200 border-2 border-gray-300 hover:border-gray-400 transition-all"
                >
                  Suivant →
                </button>
              ) : (
            ...
            {/* Question Navigator */}
            <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-lg shadow-md p-6">
              <h3 className="font-semibold text-gray-800 dark:text-gray-100 dark:text-white mb-4">
                    ...
                    className={`
                      ...
                      ${
                        idx === currentQuestion
                          ...
                          : "bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-400 dark:text-gray-400 border-2 border-gray-200 dark:border-slate-700 dark:border-slate-700 hover:border-gray-300"
                      }
                    `}
                  >
                    {idx + 1}
          ...
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-lg shadow-md p-8 text-center mb-6">
            <div className="mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-100 dark:text-white mb-2">
              Résultats
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-teal-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Score</p>
                <p className="text-2xl font-bold text-teal-600">{currentScore}%</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4">
                <Clock className="w-6 h-6 text-blue-600 mx-auto mb-2" />
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Temps</p>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Questions</p>
